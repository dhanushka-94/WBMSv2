            ...
            <form action="{{ route('meters.update', $meter) }}" method="POST" class="max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-8">
                    <div class="bg-gradient-to-r from-green-500 to-teal-600 px-6 py-4">
                        <h3 class="text-lg font-bold text-white">
                            <i class="fas fa-calendar-alt mr-2"></i>Installation & Maintenance Details
                        </h3>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <label class="block text-sm font-semibold text-gray-700">
                                    <i class="fas fa-wrench mr-1"></i>Last Maintenance Date
                                </label>
                                <input type="date" 
                            ...
                            <div class="space-y-2">
                                <label class="block text-sm font-semibold text-gray-700">
                                    <i class="fas fa-calendar-check mr-1"></i>Next Maintenance Date
                                </label>
                                <input type="date" 
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-8">
                    <div class="bg-gradient-to-r from-blue-500 to-cyan-600 px-6 py-4">
                        ...
                        <p class="text-blue-100 text-sm">Update the exact location of this water meter</p>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                <div class="space-y-2">
                                    <label class="block text-sm font-semibold text-gray-700">
                                        <i class="fas fa-map mr-1"></i>Click on map to update location
                                    </label>
...
function initMap() {
    ...
    if (lat && lng) {
        setLocation(parseFloat(lat), parseFloat(lng), document.getElementById('address').value || '');
