...
<div class="mx-auto">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-lg p-6 mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-white">Create New Rate</h1>
                <p class="text-blue-100 mt-1">Add a new billing rate and unit charge</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        <form action="{{ route('settings.rates.store') }}" method="POST" id="rateForm">
            @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" 
                               name="effective_from" 
                               id="effective_from"
                               value="{{ old('effective_from', $rate->effective_from ?? now()->format('Y-m-d')) }}"
