    ...
    <div class="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 text-white py-8 px-6 rounded-lg shadow-lg mb-8">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-blue-100 mt-2">Create a new guarantor to back customer accounts</p>
            </div>
    ...
    <form method="POST" action="{{ route('guarantors.store') }}">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <div class="relative">
                            <textarea name="address" 
                                      ...
                                      class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-amber-500 focus:outline-none transition-colors resize-none @error('address') border-red-300 @enderror">{{ old('address') }}</textarea>
                            <div class="absolute top-3 right-3">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
            <div class="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-4">
                ...
                <p class="text-green-100 text-sm mt-1">Set initial status for the guarantor</p>
            </div>
                ...
                <div class="space-y-4">
                    <div>
                        <label class="flex items-center space-x-3 cursor-pointer">
                            ...
                            <span class="text-sm font-semibold text-gray-700">Active Guarantor</span>
                        </label>
                        <p class="text-xs text-gray-500 ml-8">Active guarantors can be assigned to new customers</p>
                    </div>
                </div>
            </div>
        </div>
